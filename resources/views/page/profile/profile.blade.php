    ...
    <div class="main-content ps-3 pe-3 pt-4">
            ...
            <div class="card-body ps-3 pt-3 pe-3 pb-4">                
                ...
                <div class="col-md-3 text-center mb-3 mb-md-0">
                    <img src="{{ $profile->foto_profile === null ? asset('assets/images/new_profile.jpeg') : asset('assets/images/' . ($profile->foto_profile ?? 'default.png')) }}" class="img-fluid rounded" alt="Foto Pengguna">
