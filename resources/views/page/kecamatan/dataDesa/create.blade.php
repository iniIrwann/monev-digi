                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row gy-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="nama" type="text" class="form-control form-control-sm"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="desa" type="text" class="form-control form-control-sm"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input placeholder="nomor handphone" type="tel" pattern="[0-9]{10,15}"
                                        maxlength="15" title="Masukkan 10-15 digit angka"
                                        class="form-control form-control-sm" name="nohp" value="{{ old('nohp') }}">
                                    @error('nohp')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
