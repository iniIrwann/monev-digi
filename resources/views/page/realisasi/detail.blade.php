            ...
            <div class="card-body p-3">
                ...
                <div class="row g-1 mb-3">
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control form-control-sm rounded-1" value="{{ $subKegiatan->nama_subkegiatan }}" name="nama_subkegiatan" disabled />
                    </div>
                    <!-- Kolom Kiri -->
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="fs-12 txt-tb-grey">Uraian keluaran</label>
                            <input type="text" value="{{ $realisasi->uraian_keluaran }}" class="form-control form-control-sm rounded-1" name="uraian_keluaran" placeholder="uraian keluaran" disabled/>
                        </div>
                        <div class="mb-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-2">
                            ...
                            <input value="{{ $realisasi->KPM }}" required type="number"
                                class="form-control form-control-sm rounded-1" name="KPM" placeholder="Kosong / Belum diisi" disabled/>
                        </div>
                    </div>
                </div>
